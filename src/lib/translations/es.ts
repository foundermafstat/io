export const es = {
	...
	header: {
		title: 'Acerca de',
		about:
			'Este es un proyecto que pretende demostrar cómo usar la API en tiempo real de OpenAI con WebRTC en un proyecto moderno de Next 15. Tiene componentes shadcn/ui ya instalados y el hook de sesión de audio WebRTC ya implementado. Clona el proyecto y define tus propias herramientas.',
		banner:
			'🎉 ¡Descubre la nueva biblioteca OpenAI Realtime Blocks UI para Next.js!',
	...
	hero: {
		...
		subtitle:
			'Haga una demostración haciendo clic en el botón de abajo y pruebe las herramientas disponibles',
	...
	tools: {
		availableTools: {
			...
			copyFn: {
				description:
					'Di "Copiar eso al portapapeles" para pegarlo en algún lugar.',
				name: 'Función Copiar',
			},
			getTime: {
			...
			launchWebsite: {
				description:
					'"Llévame a [sitio web]" para abrir un sitio en una nueva pestaña.',
				name: 'Abrir Sitio Web',
			},
			partyMode: {
				description:
					'¡Di "Iniciar modo fiesta" para una animación dinámica de confeti!',
				name: 'Modo Fiesta',
			},
			themeSwitcher: {
				description:
					'Di "Cambiar fondo" o "Cambiar a modo oscuro" o "Cambiar a modo claro".',
				name: 'Cambiar Tema',
			},
			scrapeWebsite: {
				name: 'Extractor de Sitios Web',
				description:
					'Di "Extraer contenido de [URL del sitio]" para obtener contenido de una página web.',
			},
			navigateToPage: {
		...
		clipboard: {
			...
			success:
				'Texto copiado al portapapeles. Pide al usuario que lo pegue en algún lugar.',
	...
	quiz: {
		...
		intro: {
			...
			subtitle:
				'¡Encontremos tu propiedad perfecta juntos! Te guiaré a través de algunas preguntas para entender tus necesidades.',
			discover: {
		...
		steps: {
			purpose: {
				...
				subtitle:
					'¿Estás buscando alquilar una propiedad o comprarla? Esto me ayudará a adaptar las recomendaciones.',
				rent: {
					title: 'Alquilar',
					description:
						'Vida flexible, costos iniciales más bajos, prueba antes de comprar',
				},
				buy: {
					title: 'Comprar',
					description:
						'Inversión a largo plazo, construir patrimonio, crear tu hogar para siempre',
				},
			},
			budget: {
			...
			features: {
				...
				subtitle:
					'Selecciona características que son importantes para ti. Puedes elegir múltiples opciones.',
			},
			results: {
				...
				searchMessage:
					'Ahora déjame buscar propiedades que coincidan con tus criterios...',
		...
		properties: {
			...
			completeSteps:
				'Completa más pasos para ver recomendaciones personalizadas',
			adjustPreferences:
				'Intenta ajustar tus preferencias para ver más resultados',
			selected: 'Seleccionado',
			featured: 'Destacado',
			verified: 'Verificado',
			rent: 'Alquiler',
	...
	homepage: {
		...
		features: {
			...
			convenientSearch: {
				...
				description:
					'Proceso de búsqueda de propiedades intuitivo con IA. Obtén recomendaciones personalizadas e instantáneas de grandes ofertas.',
			},
			secureTransactions: {
				title: 'Transacciones Seguras',
				description:
					'Verificación exhaustiva, términos transparentes y documentación completa. Propiedades verificadas y servicios seguros confiables.',
			},
			smartNavigation: {
				title: 'Navegación Inteligente',
				description:
					'Análisis de ubicaciones con IA e investigación detallada de vecindarios para encontrar la propiedad perfecta, haciendo que el proceso de búsqueda sea simple y agradable.',
			},
		},
		testimonials: {
		...
		footer: {
			...
			sections: {
				...
				newsletter: 'Boletín',
				newsletterText:
					'¡Únete a nuestra comunidad! Obtén ofertas exclusivas y análisis de mercado.',
	...
	propertyDetail: {
		...
		owner: 'Propietario',
		realEstateAgency: 'Agencia Inmobiliaria',
